var initTaskInfo = (function (_super) {
    __extends(initTaskInfo, _super);
    function initTaskInfo(stageWidth, stageHeight) {
        _super.call(this);
    ...
    var d = __define,c=initTaskInfo,p=c.prototype;
    return initTaskInfo;
}(egret.DisplayObjectContainer));
egret.registerClass(initTaskInfo,'initTaskInfo');
